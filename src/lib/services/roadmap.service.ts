// PathCraft AI – Roadmap Service (Sanvi's layer)
// Ported from feature/sanvi-backend-db:lib/services/roadmap.service.ts
...
export async function getRoadmapGraph(
  ...
  return {
    ...
    nodes: roadmap.nodes as unknown as RoadmapNode[],
    edges: roadmap.edges as unknown as RoadmapEdge[],
  };
}
